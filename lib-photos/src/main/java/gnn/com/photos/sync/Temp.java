...
public class Temp {
    ...
    public Temp(ArrayList<Photo> toDownload, ArrayList<Photo> toDelete) {
        this.albumSize = 0;
        this.deleteCount = 0;
        this.downloadCount = 0;
    ...
    // For Test
    public Temp(int albumSize, int deleteCount, int downloadCount, ArrayList<Photo> downloadLst, ArrayList<Photo> deleteLst, int currentDownload, int currentDelete) {
    ...
    public boolean equals(Object o) {
        ...
        Temp temp = (Temp) o;
        return albumSize == temp.albumSize && deleteCount == temp.deleteCount && downloadCount == temp.downloadCount && Objects.equals(toDownload, temp.toDownload) && Objects.equals(toDelete, temp.toDelete);
    }
